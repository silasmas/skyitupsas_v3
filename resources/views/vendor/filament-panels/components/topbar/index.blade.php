...
>
    <nav
        class="flex h-16 w-full items-center gap-x-4 bg-white px-4 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 md:px-6 lg:px-8"
    >
        ...
        @if (filament()->isGlobalSearchEnabled())
            <div class="flex min-w-0 max-w-xl flex-1 items-center justify-center px-2">
        ...
        <div
            ...
            @endif
            class="flex min-w-0 flex-1 items-center justify-end gap-x-4"
        >
